...
public class VoldemortBuildAndPushJob extends AbstractJob {
    ...
    public void run() throws Exception {
        ...
        log.info("multicoloPush is : " + multicoloPush);
        log.info("clustersMatch is : " + clustersMatch);
        log.info("clusterUrl.size() is : " + clusterUrl.size());
            ...
            try {
                ...
                if(push) {
                    ...
                    for(int index = 0; index < clusterUrl.size(); index++) {
                        ...
                        log.info("Pushing to : " + clusterUrl.get(index));
                        PushThread pRunnable = new PushThread(clusterUrl.get(index), buildOutputDir);
    ...
    public void runPushStore(Props props, String url, String dataDir) throws Exception {
        ...
        AdminClient thisadminClient = new AdminClient(url, new AdminClientConfig());
        ...
        new VoldemortSwapJob(this.getId() + "-push-store",
                             props,
                             new VoldemortSwapConf(thisCluster,
                                                   dataDir,
                                                   storeName,
                                                   httpTimeoutMs,
                                                   pushVersion,
