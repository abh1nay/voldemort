...
import voldemort.store.delta.DeltaStoreBuilderJob.DeltaStoreBuilderConf;
...
public class DeltaPushJob extends AbstractJob {
    ...
    public DeltaPushJob(String name, Props props) {
        super(name);
        this.props = props;
    ...
    public static String getDeltaStoreDefXml(String storeName,
    ...
    public void verifySchema(String url) throws Exception {
        ...
        String newStoreDefXml = getDeltaStoreDefXml(storeName,
                                                    replicationFactor,
                                                    requiredReads,
                                                    requiredWrites,
                        ...
                        if(remoteKeySerializerDef.getName().equals("json")
                           ...
                           && remoteValueSerializerDef.getAllSchemaInfoVersions().size() == 1) {
                            ...
                            if(remoteKeyDef.equals(localKeyDef) && remoteValDef.equals(localValDef)) {
                                ...
                                // they
                                // match, and try again.
                                newStoreDefXml = getDeltaStoreDefXml(storeName,
                                                                     replicationFactor,
                                                                     requiredReads,
                                                                     requiredWrites,
                                                                     props.containsKey("build.preferred.reads") ? props.getInt("build.preferred.reads")
    ...
    public String runBuildStore(Props props, String url) throws Exception {
        ...
        if(isAvroJob) {
            ...
            new DeltaStoreBuilderJob(this.getId() + "-build-store",
                                     props,
                                     new DeltaStoreBuilderConf(replicationFactor,
                                                               chunkSize,
                                                               tempDir,
                                                               outputDir,
                                                               inputPath,
